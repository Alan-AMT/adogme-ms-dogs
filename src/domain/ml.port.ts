...
export abstract class MlDogPort{
    ...
    abstract updateMlDog(dog: UpdateDogDto, adoptionFee: number, dogId: string, amountImages: number): Promise<{adoption_speed: number, speed_label: string, dog_vector: number[]}>;
